import { Controller, Get, HttpStatus, HttpException, BadRequestException, NotFoundException, UseFilters } from '@nestjs/common'
...
export class AppController {
  ...
  @Get('hello')
  // @UseFilters(HttpExceptionFilter) // 使用 @UseFilters 客製錯誤拋出的格式，可以在個別路由中套用，但更建議在 app 層級統一使用 app.useGlobalFilters (請至 main.ts 查看)
  getHello(): string {
